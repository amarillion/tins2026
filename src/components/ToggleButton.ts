...
export class ToggleButton {
	...
	normalStyle: Phaser.Types.GameObjects.Text.TextStyle & { fill?: string | CanvasGradient | CanvasPattern };
	toggledStyle: Phaser.Types.GameObjects.Text.TextStyle & { fill?: string | CanvasGradient | CanvasPattern };
	 ...
	 */
	handlePointerOver() {
		this.textObject.setStyle({ fill: '#cccccc' });
	}
